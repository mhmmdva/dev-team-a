            ...
            <tbody class=" table-group-divider">
                @foreach ($user as $users)
                    <tr>
                        ...
                        <td>{{ $users->email }}</td>
                        <td>{{ $users->updated_at->format('Y-M-D') }}</td>
                        ...
                        <td>
                            ...
                            <a href="{{ route('category.edit', $users->id) }}" class="btn btn-warning btn-sm text-white">
                    ...
                    {{-- Modal Delete --}}
                    {{-- <div class="modal fade" id="Modal{{ $users->id }}" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
