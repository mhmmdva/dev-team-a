...
<div class="container">
                ...
                <div class="col-lg-6">
                    <div class="row justify-content-center">
                        <div class="col-md-4 my-3">
                            <center><img src="{{ Auth::user()->photo() }}" width="125" height="125" class="rounded-circle"><br><br>
    ...
    <h2 class="mt-4" style="font-weight: 700;">Article by <span style="color: #5DAAC4">{{ Auth::user()->name }}</span>
    </h2>
    <div class="card mb-4">
        <div class="card-body">
            <table class="table">
